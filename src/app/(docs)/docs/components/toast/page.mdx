...
<Description>命令型 API で通知を表示するトーストコンポーネント。</Description>

## Installation

<CodeBlock
  code={`npx shadcn@latest add https://kasumi-ui.vercel.app/r/toast.json`}
/>
...
<CodeBlock
  code={`toast({ title: "通知", variant: "default" });
