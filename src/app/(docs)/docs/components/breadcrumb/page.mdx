...
export const breadcrumbProps = [
  {
    ...
    type: "ReactNode",
    default: "-",
    description: "BreadcrumbSeparator のカスタムアイコン（省略時は ChevronRight）",
  },
];

# Breadcrumb

<Description>ページの階層構造を示すパンくずリストコンポーネント。Breadcrumb / BreadcrumbList / BreadcrumbItem / BreadcrumbLink / BreadcrumbPage / BreadcrumbSeparator の複合構成。</Description>
