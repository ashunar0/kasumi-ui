...
<Description>情報をグループ化して表示するカードコンポーネント。Card / CardHeader / CardTitle / CardDescription / CardContent / CardFooter の複合構成。</Description>
...
<ComponentPreview>
  <Card className="w-full max-w-sm">
    ...
    <CardContent>
      <p className="text-sm text-muted-foreground">候補日: 3月15日（土）、3月16日（日）</p>
    </CardContent>
    <CardFooter>
...
<ComponentPreview>
  <Card className="w-full max-w-sm">
    <CardContent className="pt-6">
      <p className="text-sm text-muted-foreground">シンプルなカードコンテンツ。CardHeader を省略してコンテンツだけ表示することもできます。</p>
    </CardContent>
  </Card>
</ComponentPreview>
