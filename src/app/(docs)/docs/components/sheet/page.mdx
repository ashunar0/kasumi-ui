...
<CodeBlock
  code={`npx shadcn@latest add https://kasumi-ui.vercel.app/r/sheet`}
/>
...
<ComponentPreview>
  <Sheet>
    ...
    <SheetContent>
      ...
      <SheetDescription>{"アプリケーションの設定を変更できます。"}</SheetDescription>
    </SheetContent>
  </Sheet>
</ComponentPreview>
...
<ComponentPreview>
  <Sheet>
    ...
    <SheetContent>
      ...
      <SheetDescription>{"表示名とメールアドレスを変更できます。"}</SheetDescription>
