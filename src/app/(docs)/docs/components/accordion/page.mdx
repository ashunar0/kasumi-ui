...
<Description>開閉可能なセクションで情報を折りたたんで表示するコンポーネント。Radix UI ベース。Accordion / AccordionItem / AccordionTrigger / AccordionContent の複合構成。</Description>
...
<CodeBlock code={`<Accordion type="single" collapsible defaultValue="item-2">
  <AccordionItem value="item-1">
    <AccordionTrigger>セクション 1</AccordionTrigger>
