...
<CodeBlock code={`npx shadcn@latest add https://kasumi-ui.vercel.app/r/theme.json`} lang="bash" />
...
<CodeBlock code={`npx shadcn@latest add https://kasumi-ui.vercel.app/r/button.json`} lang="bash" />
